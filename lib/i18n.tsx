...
const en = {
  ...
  shows: {
    newVersionToast: (version: string) => `New in v${version} — tap to see what changed`,
    tabList: "My list",
  ...
  profile: {
    ...
    badgeCategoryReactions: "Reactions given",
    ...
    about: "About",
    whatsNew: "What's new",
    whatsNewVersion: (version: string) => `Version ${version}`,
  ...
  support: {
    ...
    sendReply: "Send",
    replyFailed: "Couldn't send your reply. Try again.",
  },
  admin: {
    title: "Admin",
    open: "Open",
    ...
    needsResponse: "Needs reply",
    replyPlaceholder: "Write a reply...",
    sendReply: "Send reply",
    reopen: "Reopen",
    supportYou: "You (support team)",
    supportUser: "User",
  ...
  comments: {
    ...
    delete: "Delete",
    cancel: "Cancel",
    viewReplies: (n: number) => `View ${n} ${n > 1 ? "replies" : "reply"}`,
...
const fr: typeof en = {
  ...
  shows: {
    newVersionToast: (version: string) => `Nouveau dans la v${version} — appuie pour voir quoi`,
    tabList: "Ma liste",
    tabUpcoming: "À venir",
    history: "Historique",
    watchNext: "À suivre",
  ...
  movies: {
    ...
    sortAscending: "Plus anciens d'abord",
    sortDescending: "Plus récents d'abord",
  ...
  profile: {
    ...
    badgeCategoryReactions: "Réactions données",
  ...
  support: {
    ...
    sendReply: "Envoyer",
    replyFailed: "Impossible d'envoyer ta réponse. Réessaie.",
  },
  admin: {
    title: "Admin",
    open: "Ouverts",
    ...
    needsResponse: "Réponse attendue",
    replyPlaceholder: "Écrire une réponse...",
    sendReply: "Envoyer",
    reopen: "Rouvrir",
    supportYou: "Toi (support)",
    supportUser: "Utilisateur",
  ...
  comments: {
    ...
    delete: "Supprimer",
    cancel: "Annuler",
    viewReplies: (n: number) => `Voir ${n} réponse${n > 1 ? "s" : ""}`,
